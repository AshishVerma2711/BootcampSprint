...
class RetailerServiceImplTest {
	...
	void addRetailerPass() {
		RetailerDto retailer = new RetailerDto("Bansal and sons", "121, near ashok plaza", "133486", "Maholi", "Punjab",
				"8958684455", "bansalshubhy@gmail.com");
	...
	void addRetailerExcpetion() {
		RetailerDto retailer = new RetailerDto("Singla Sports", "S.C.F. 128 , Phase 12 SAS Nagar Mohali", "160064",
				"Mohali", "Punjab", "7889546213", "singlasports@gmail.com");
		Assertions.assertThrows(RetailerExcpetion.class, () -> {
	...
	@Test
	void updatePass() {
		RetailerDto retailer = new RetailerDto("R10003", "Sudhanshu Sports", "S.C.F. 128 , Phase 12 SAS Nagar Mohali",
				"160064", "Mohali", "Punjab", "7889546213", "singlasports@gmail.com");
		assertThat(retailerService.updateRetailer(retailer)).isNotNull();
	}

	@Test
	void updateException() {
		RetailerDto retailer = new RetailerDto("R10005", "Sudhanshu Sports", "S.C.F. 128 , Phase 12 SAS Nagar Mohali",
				"160064", "Mohali", "Punjab", "7889546213", "singlasports@gmail.com");
		Assertions.assertThrows(RetailerExcpetion.class, () -> {
	...
	void getRetailerException() {
		Assertions.assertThrows(RetailerExcpetion.class, () -> {
			retailerService.getRetailer("R10005");
		});
	}
